...
const experiences = [
  ...
  },
  {
    ...
    image: "public/zettabyte.png",
  },
];

const Experiences = () => {
  return (
    <div className="bg-[url('public/bg-experiences.png')] bg-cover bg-center w-screen min-h-screen flex items-center justify-center relative" id="experiences">
