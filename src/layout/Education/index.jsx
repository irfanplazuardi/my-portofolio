...
const Education = () => {
  return (
    <div className="bg-[url('src/assets/bg-education.png')] bg-cover bg-center w-screen min-h-screen flex items-center justify-center relative" id="education">
      ...
      <img src="src/assets/blue-mushroom.svg" alt="blue-mushroom" className="absolute left-52 lg:left-36 -center-10" />
      ...
      <img src="src/assets/red-mushroom.svg" alt="red-mushroom" className="absolute -center-10 transform -translate-x-1/2 left-1/2 " />
      ...
      <img src="src/assets/green-mushroom.svg" alt="green-mushroom" className="absolute right-52 lg:right-36 -center-10" />
