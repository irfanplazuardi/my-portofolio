...
const projects = [
  {
    ...
    links: [
      { type: "website", href: "https://dev--vogueschool-dev-env.netlify.app/", imgSrc: "/website.png", address: "vogueschool" },
...
const Projects = () => {
  ...
  return (
    <div className="bg-[url('/bg-projects.png')] bg-cover bg-center w-screen min-h-screen flex items-center justify-center relative" id="projects">
      ...
      <div className="bg-green-700 bg-opacity-75 rounded-xl w-11/12 h-full shadow-lg px-20 py-10 mt-20">
        <Slider {...settings}>
          {projects.map((project, index) => (
            <div key={index} className="bg-white bg-opacity-50 rounded-xl shadow-lg h-[70vh]">
              ...
              <div className="flex justify-between gap-10 p-5 ">
                <img src={project.imgSrc} alt={project.title} className="w-1/2 h-fit lg:h-80" />
                <div className="gap-5">
                  ...
                  <div className="flex gap-10 pt-10 lg:pt-2">
                    {project.links.map((link, idx) => (
                      <div key={idx} className="flex gap-2 items-center lg:flex-col">
